# Getting started with WTF-P 0.6.0
...
- For Clio Coder, version 0.4.7 or newer (`npm install -g @iowarp/clio-coder`). WTF-P installs into Clio as a plugin package through `clio-coder library install`.
