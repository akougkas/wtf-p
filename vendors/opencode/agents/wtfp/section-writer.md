...
Visual format: `@~/.opencode/write-the-f-paper/references/ui-brand.md`
...
Use `the question tool` to collect the author's response.
...
Handle deviations during writing. Canonical source: `@~/.opencode/write-the-f-paper/references/deviation-rules.md`
...
<step name="summary">
Create SUMMARY.md after all tasks complete. Follow the template at `@~/.opencode/write-the-f-paper/templates/summary.md`.
