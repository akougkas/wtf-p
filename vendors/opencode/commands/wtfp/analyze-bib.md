...

{
  ...
  "effects": [
    ...
    },
    {
      ...
      "scope": "project://evidence/{evidence}, project://validations/{validation}"
    },
    {
    ...
    {
      "id": "filesystem.read",
      "scope": "project://manifest, project://structure/outline, project://sources/{source}, project://materials/{artifact}, project://paper/{artifact}"
    },
    {
      "id": "tool.execute",
