...
<details data-wtfp-source="protocol://actions/progress.json" open>
<summary>Bundled WTF-P protocol resource: actions/progress.json</summary>

{
  ...
  "workflow": "wtfp://workflows/progress",
  "requirements": {
    "capabilities": [
      "filesystem.read",
      "user.interaction"
  ...
  "effects": [
    ...
    {
      "id": "user.gate",
      "scope": "selection of the recommended next action"
    }
  ]
}
