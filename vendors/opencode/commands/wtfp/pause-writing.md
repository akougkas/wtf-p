...
<details data-wtfp-source="protocol://actions/pause-writing.json" open>
<summary>Bundled WTF-P protocol resource: actions/pause-writing.json</summary>

{
  ...
  "title": "Pause writing",
  "description": "Record an exact context handoff so another session can resume without reconstructing intent.",
  "alias": "wtfp:pause-writing",
  "surface": {
    "kind": "skill",
    "skill": "wtfp-manage-project"
  },
  "workflow": "wtfp://workflows/pause-writing",
  "requirements": {
    "capabilities": [
      "filesystem.read",
      "filesystem.write"
