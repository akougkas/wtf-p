...

{
  ...
  "effects": [
    ...
    {
      "id": "filesystem.read",
      "scope": "project://manifest, project://config, project://state, project://decisions, project://structure/outline, project://validations/*, project://sections/{section}, project://sections/{section}/context, project://sections/{section}/research, project://sections/{section}/summary, project://sources/{source}, project://evidence/{evidence}"
    },
    {
      "id": "filesystem.write",
      "scope": "project://sections/{section}/plans/{plan}, project://validations/{validation}, project://checkpoints/{checkpoint}, project://sections/{section}, project://state"
    },
    {
      "id": "user.gate",
      "scope": "plan approval, verifier exceptions, and recovery checkpoint approval after complete preview"
    }
  ]
}
