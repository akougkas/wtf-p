...
<details data-wtfp-source="protocol://actions/resume-writing.json" open>
<summary>Bundled WTF-P protocol resource: actions/resume-writing.json</summary>

{
  ...
  "description": "Restore the latest portable handoff and route the researcher to the next safe action.",
  "alias": "wtfp:resume-writing",
  "surface": {
    "kind": "skill",
    "skill": "wtfp-manage-project"
  },
  "workflow": "wtfp://workflows/resume-writing",
  "requirements": {
    "capabilities": [
      "filesystem.read",
      "filesystem.write",
  ...
  "effects": [
    ...
    {
      "id": "user.gate",
      "scope": "selection of the resumed action"
    }
  ]
}
