...
<details data-wtfp-source="protocol://actions/add-todo.json" open>
<summary>Bundled WTF-P protocol resource: actions/add-todo.json</summary>

{
  ...
  "workflow": "wtfp://workflows/add-todo",
  "requirements": {
    "capabilities": [
      "filesystem.read",
      "filesystem.write"
  ...
  "effects": [
    ...
    {
      "id": "filesystem.read",
      "scope": "project://manifest, project://state, project://checkpoints/{checkpoint}"
    }
  ]
}
