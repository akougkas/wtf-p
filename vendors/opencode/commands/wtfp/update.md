...
<details data-wtfp-source="protocol://actions/update.json" open>
<summary>Bundled WTF-P protocol resource: actions/update.json</summary>

{
  ...
  "requirements": {
    ...
    "conditions": [
      "The active installation target and scope are explicit"
    ]
  },
  "reads": [
    "package://metadata",
  ...
  "effects": [
    {
      "id": "network.fetch",
      "scope": "configured WTF-P release registry"
    },
    {
      "id": "package.update",
      "scope": "the explicit installation target and scope"
    },
    {
      "id": "user.gate",
      "scope": "release selection and package replacement"
    }
  ]
}
