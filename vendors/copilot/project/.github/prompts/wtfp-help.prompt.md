...
Read: `.github/wtfp/catalog.json`, `.github/wtfp/actions/{action}.json`.
Produce: none.
...
4. Read `.github/wtfp/compatibility/action-availability.json` and mark every action it reports as unavailable, naming the capability or effect that blocks it. Do not imply capabilities that the selected adapter does not expose.
...
[actions/help.json](../wtfp/actions/help.json)
